<script>
  ...
  let nombre = '', apellido = '', email = '', password = '', confirmPassword = ''
  ...
  async function handleRegister() {
    ...
    currentUser.set({ id: 'u-new', nombre, apellido, email })
    push('/dashboard')
  }
</script>
...
<style>
  ...
  .back-link {
    ...
    padding: 0; margin-bottom: 24px; display: block;
  }
  ...
  .btn-primary {
    background: var(--green-800); color: var(--green-50); border: none;
